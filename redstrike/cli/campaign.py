...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description="Campaign graph orchestrator. Pass --graph. CADRE_ROOT is optional practice glue; CADRE Plan 01 uses the CADRE/tools/red-strike pin.",
    )
    ...
    def add_common(p: argparse.ArgumentParser, *, beachhead_required: bool = False) -> None:
        ...
        p.add_argument(
            "--seed",
            default=None,
            help="JSON seed (default: REDSTRIKE_SEED, CADRE_ROOT lab seed, or examples/seed.example.json)",
        )
