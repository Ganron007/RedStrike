...
> **Campaign automation:** see internal planning docs in `docs/internal/` (gitignored) (local-only planning docs, gitignored). **SSoT = this repo**; sync major features → `CADRE/tools/red-strike/`.  
